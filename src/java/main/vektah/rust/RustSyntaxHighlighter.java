...
public class RustSyntaxHighlighter extends SyntaxHighlighterBase {
	...
	private static final    TextAttributesKey[] PATH_SEPARATOR_KEYS = new TextAttributesKey[]{PATH_SEPARATOR};
	private static final    TextAttributesKey[] DELIMITER_KEYS      = new TextAttributesKey[]{DELIMITER};
